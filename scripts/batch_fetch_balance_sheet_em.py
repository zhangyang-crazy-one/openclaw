#!/usr/bin/env python3
"""
批量补全 EastMoney 资产负债表
使用akshare stock_balance_sheet_by_report_em
"""
...
OUTPUT_FILE = DATA_DIR / "balance_em.csv"
...
def main():
    print(f"[{datetime.now().strftime('%H:%M:%S')}] 资产负债表批量采集开始...")
